...
import type { Lesson, SidebarItem } from '@/lib/quizzes'
...
export default function ContentPage({ courseTitle, lesson, source, prevItem, nextItem }: Props) {
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-7 sm:pt-10 md:pt-12 pb-20">
      <header className="mb-8 sm:mb-10">
        <p className="text-[11px] font-bold tracking-widest uppercase text-ink-3 mb-2">
          {courseTitle} · Lesson {lesson.lesson}
        </p>
